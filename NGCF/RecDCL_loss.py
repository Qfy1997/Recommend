...
RecDCL_loss
"""
class RecDCL_loss(nn.Module):
    def __init__(self,
                 batch_size:int,
                 decay_ratio:float=1e-5):
        super(RecDCL_loss, self).__init__()
    ...
    def forward(self,user_e, item_e, lightgcn_all_embeddings, u_target, i_target):
        coeff = 5
        poly_coeff = 0.2
        ...
        loss =  bt_loss + poly_loss * poly_coeff + mom_loss * coeff # coeff=5 poly_coeff 0.2 
